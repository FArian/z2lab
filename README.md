...
```
OrderEntry/
├── frontend/zetlab/   # Next.js 15.5 app (TypeScript strict, Tailwind CSS v4)
...
| | Layer | Description |
|---|---|---|
| 🎯 | [Domain](./frontend/zetlab/src/domain/README.md) | Pure business rules — entities, use cases, factories |
| 📋 | [Application](./frontend/zetlab/src/application/README.md) | Services, interfaces, strategies |
| 🔧 | [Infrastructure](./frontend/zetlab/src/infrastructure/README.md) | FHIR, HTTP, config, API controllers |
| 🎨 | [Presentation](./frontend/zetlab/src/presentation/README.md) | React hooks, components, design system |
| 🗂️ | [Shared](./frontend/zetlab/src/shared/README.md) | Framework-agnostic utilities and client-safe config |
| 🖥️ | [App](./frontend/zetlab/src/app/README.md) | Next.js App Router pages and API routes |
| 📝 | [Messages](./frontend/zetlab/src/messages/README.md) | i18n translations (de, en, fr, it) |
| 🧪 | [Tests](./frontend/zetlab/tests/README.md) | Unit, integration, mocks |
...
2. ORDER ENTRY  Clinician → ZetLab App → ServiceRequest (POST to HAPI FHIR)
...
| [src/README.md](./frontend/zetlab/src/README.md) | Clean Architecture layer map |
| [tests/README.md](./frontend/zetlab/tests/README.md) | Test structure and rules |
